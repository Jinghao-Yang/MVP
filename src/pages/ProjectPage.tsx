    ...
    >
      ...
      <div className="flex items-center gap-4 font-mono text-[9px] font-bold text-neutral-400 uppercase tracking-widest">
        <span className="flex items-center gap-1.5">
          <Link2 className="w-3 h-3 text-[var(--bh-red)]" /> {card.links}
        </span>
        <span className="flex items-center gap-1.5">
          <FileText className="w-3 h-3 text-[var(--bh-blue)]" /> {card.words}
        </span>
      </div>
    </div>
  );
                ...
                <DndContext onDragEnd={handleDragEnd}>
                  <div className="grid grid-cols-1 md:grid-cols-4 h-full">
                    <LedgerColumn
                      ...
                      index="01"
                      title="Fleeting"
                      cards={kanbanData.fleeting}
                    />
                    <LedgerColumn
                      id="seedling"
                      index="02"
                      title="Seedling"
                      cards={kanbanData.seedling}
                    />
                    <LedgerColumn
                      id="evergreen"
                      index="03"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
                  <div className="space-y-4 pt-10 relative group cursor-pointer changelog-node">
                    ...
                    <div className="brutal-card p-5 border border-white">
                      ...
                      <p className="font-sys text-xs text-neutral-600 leading-relaxed">
                        Formulated the first draft of compactness equivalence in metric
                        environments.
                      </p>
                    </div>
                  </div>
                  <div className="space-y-4 pt-10 relative group cursor-pointer changelog-node">
                    ...
                    <div className="brutal-card p-5 border border-white">
                      ...
                      <p className="font-sys text-xs text-neutral-600 leading-relaxed">
                        Discovered a critical counterexample regarding non-Hausdorff infinite
                        products.
                      </p>
                    </div>
                  </div>
                  <div className="space-y-4 pt-10 relative group cursor-pointer changelog-node">
                    ...
                    <div className="font-mono text-[11px] text-[var(--bh-red)] font-bold">
                      JUN 03
                    </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-6 items-center gap-4 gantt-item">
                    <div className="col-span-2 font-bold text-xs flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full dot-blue"></span> Topology
                      Foundations
                    </div>
                    <div className="col-span-3 col-start-3 brutal-card p-3 flex justify-between border border-white">
                      ...
                      <span className="text-[11px] text-[var(--bh-red)] font-bold">
                        ◆ Public Beta
                      </span>
                    </div>
                  </div>
