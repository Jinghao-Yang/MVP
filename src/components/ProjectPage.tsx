    ...
    <div className="page-panel flex-1 flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8 scroll-hide">
        <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div className="page-panel space-y-8 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="stage-column">
                  ...
                  <div className="brutal-card p-4 mb-3" draggable>Heine–Borel origins</div>
                  <div className="brutal-card p-4 mb-3" draggable>Non-Hausdorff products</div>
                </div>
                <div className="stage-column">
                  <div className="column-header"><span className="indicator-dot dot-blue"></span> 2. Seedling</div>
                  <div className="brutal-card p-4 mb-3" draggable>Compactness ↔ sequential</div>
                </div>
                <div className="stage-column">
                  <div className="column-header"><span className="indicator-dot dot-red"></span> 3. Evergreen</div>
                  <div className="brutal-card p-4 mb-3" draggable>Lemma 2.4: finite subcover</div>
                </div>
                <div className="stage-column">
                  <div className="column-header"><span className="indicator-dot dot-green"></span> 4. Synthesis</div>
                  <div className="brutal-card p-4 mb-3 opacity-50" draggable>Drop here to output</div>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === 'gallery' && (
            <div className="page-panel space-y-8 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 items-stretch">
                <div onClick={() => openPage("editor")} className="brutal-card card-theorem p-6 flex flex-col justify-between group">
          ...
          {activeTab === 'timeline' && (
            <div className="page-panel space-y-8 animate-fade-in">
              <div><h2 className="font-human text-4xl font-normal tracking-tight">Timeline</h2></div>
              <div className="text-neutral-400 font-mono text-sm">(Gantt visualization rendering...)</div>
            </div>
          )}
