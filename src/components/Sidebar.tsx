  ...
  return (
    <aside className={`sidebar glass-panel ${isCollapsed ? 'collapsed' : ''}`} id="sidebar">
      <div className="h-20 px-6 flex items-center justify-between shrink-0 relative group">
        <span className="logo-full font-sys text-base font-bold tracking-widest text-text-main">
          AXIOM
        </span>
        <span className="logo-single font-sys text-base font-bold tracking-widest text-text-main absolute">
          A
        </span>
        <span className="logo-full font-mono text-[9px] text-[var(--text-muted)] opacity-60 transition-opacity">
          v0.8
        </span>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-4 space-y-8 scroll-hide text-xs text-[var(--text-secondary)] font-medium">
        <div className="space-y-1">
          <button
            ...
            className="spring-click hover-ui w-full flex items-center gap-3 px-3 py-2 text-left group"
          >
            ...
            <kbd className="font-mono text-[9px] opacity-0 group-hover:opacity-50 transition-opacity">
              ⌘K
            </kbd>
          </button>
          <button
        ...
        <div>
          <div className="sidebar-label text-[9px] uppercase tracking-widest text-[var(--text-muted)] opacity-50 mb-3 px-3">
            Focus
          </div>
          <div className="space-y-1">
            <div
              className="spring-click hover-ui px-3 py-2 flex items-center gap-3 text-[var(--text-main)] font-semibold group"
            ...
            <div
              className="spring-click hover-ui px-3 py-2 flex items-center gap-3 group"
      ...
      <div className="absolute bottom-4 right-4 opacity-0 hover:opacity-100 transition-opacity duration-300">
        <button
          className="w-8 h-8 flex items-center justify-center hover-ui bg-white/50 backdrop-blur"
          onClick={onToggle}
