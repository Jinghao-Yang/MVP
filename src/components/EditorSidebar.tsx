      ...
      {activeTab === 'context' ? (
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div>
            <ul className="space-y-1 font-sys text-xs text-[var(--text-secondary)]">
              <li
                className="spring-click flex justify-between items-center p-2 hover-ui group cursor-pointer rounded-none"
                onClick={() => setStatus?.('Tracing origin…')}
              >
                <span className="flex items-center gap-2">
                  <GitMerge className="w-3.5 h-3.5 opacity-50" /> Trace Origin
                </span>
              ...
              >
                <span className="flex items-center gap-2">
                  <Zap className="w-3.5 h-3.5 opacity-50" /> Find Paradox
                </span>
        ...
        <div className="space-y-8 animate-[tab-pane-fade_0.25s_ease-out] font-sys">
          <div className="space-y-2">
            <div className="font-mono text-[9px] uppercase tracking-wider text-[var(--bh-red)] font-bold">
              Ref. ¶ 1.1 / Line 3
            </div>
            <p className="prose-reading font-human italic leading-relaxed">
              "bridges the intuitive notion of closeness..."
            </p>
            <p className="prose-reading font-human text-neutral-500 leading-relaxed">
          ...
          <div className="space-y-2">
            <div className="font-mono text-[9px] uppercase tracking-wider text-[var(--bh-blue)] font-bold">
              Ref. ¶ 1.2 / Heine–Borel
            </div>
            <p className="prose-reading font-human italic leading-relaxed">
          ...
          <div className="w-full h-px bg-neutral-200/50"></div>
          <div className="space-y-2">
            <div className="font-mono text-[9px] uppercase tracking-wider text-[var(--bh-green)] font-bold">
              Ref. ¶ 1.3 / Tychonoff
            </div>
            <p className="prose-reading font-human italic leading-relaxed">
            ...
            <p className="prose-reading font-human text-neutral-500 leading-relaxed">
              Kelley (1950) proved that Tychonoff's theorem actually implies the Axiom of Choice in
