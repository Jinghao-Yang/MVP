    ...
    <main className="flex-1 flex flex-col h-full overflow-y-auto scroll-hide">
      <header className="h-20 flex items-center justify-between px-12 z-10 shrink-0 sticky top-0 bg-gradient-to-b from-[var(--bg-canvas)] to-transparent">
        ...
        <div className="flex items-center gap-1.5 p-1 bg-white/30 backdrop-blur-md border border-black/5">
          ...
          >
            Annotations{' '}
            <span className="bg-[var(--bh-red)] text-white px-1.5 py-0.5 rounded-full text-[8px] leading-none font-sans">
              3
            </span>
          </button>
      ...
      <div className="px-12 lg:px-20 pt-16 pb-64 flex justify-center">
        <div className="w-full max-w-[680px] relative">
          <div className="mb-12">
            ...
            <h1
              className="font-human text-6.5xl tracking-tight text-[var(--text-main)] leading-[1.05] outline-none"
              contentEditable
          ...
          <div className="space-y-12 animate-in fade-in duration-150">
            ...
            >
              ...
              <span
                ...
                onMouseEnter={(e) => onLinkHover(e, 'compactness', 0)}
                onMouseLeave={() => onLinkLeave('compactness')}
              >
                closeness
              </span>{' '}
              without relying on strict metrics. The essence of compactness captures the idea that a
              space is, in some sense, "not too large" or "manageable", even if it contains
            ...
            >
              ...
              <span
                className="wiki-link font-bold"
                onMouseEnter={(e) => onLinkHover(e, 'heine-borel', 0)}
                onMouseLeave={() => onLinkLeave('heine-borel')}
              >
                Heine–Borel
              </span>{' '}
            ...
            >
              ...
              <span
                className="wiki-link font-bold"
                onMouseEnter={(e) => onLinkHover(e, 'tychonoff', 0)}
                onMouseLeave={() => onLinkLeave('tychonoff')}
              >
                Tychonoff's Theorem
              </span>
              , which extends compactness to arbitrary products — a deep result relying on the Axiom
              of Choice.
            </p>
          </div>

          <EditorSidebar isZenMode={isZenMode} activeTab={activeSidebarTab} />
        </div>
      </div>
    </main>
  );
